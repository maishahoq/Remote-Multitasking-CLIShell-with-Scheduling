...
int main() 
{
    ...
    while(1) {
        ...
        pthread_create(&tid, NULL, ThreadRun, inputString);
...
void* ThreadRun(void* args) {
       ...
       // }
        ...
        int i=0;
         do{
            ...
            if(strcmp(parsed[0], "cd") == 0 || strcmp(parsed[0], "ping") == 0 || strcmp(parsed[0], "man") == 0)
            {
    ...
    printf("Before closing sock");
    close(sock);

    printf("After closing sock");
    pthread_exit(NULL);
